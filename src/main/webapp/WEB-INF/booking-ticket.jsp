            ...
            <div class="p-8 text-center bg-gray-50">
                ...
                <div class="flex flex-col gap-3">
                    <a href="${pageContext.request.contextPath}/payment/${booking_id}/invoice"
                        onclick="return confirm('Sau khi đặt vé bạn sẽ không thể chỉnh sửa, bạn có chắc muốn đặt vé không?.');"
                        class="w-full bg-primary hover:bg-primary-container text-white font-bold py-3.5 rounded-xl transition-all shadow-md hover:shadow-lg flex justify-center items-center gap-2 group">
                        <span class="material-symbols-outlined text-lg group-hover:translate-x-1 transition-transform">receipt_long</span>
                        Xác nhận đặt vé
                    </a>
                    ...
                    <a href="${pageContext.request.contextPath}/ticket/${booking_id}/cancel"
                       ...
                       class="w-full bg-white border-2 border-error/20 hover:bg-error/10 text-error font-bold py-3.5 rounded-xl transition-colors flex justify-center items-center gap-2 group">
