        ...
        <main class="pt-28 px-6">
            <div class="max-w-6xl mx-auto space-y-6">
                ...
                <div class="flex justify-between items-center gap-4 flex-wrap">
                    <form method="get" action="${pageContext.request.contextPath}/admin/movies"
                          class="flex gap-3">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/movies/create"
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3">
                                    <div class="flex justify-center gap-2 flex-wrap">
                                        <a href="${pageContext.request.contextPath}/admin/movies/edit/${m.movieId}"
                                           class="bg-yellow-500 text-white px-3 py-1 rounded-lg hover:bg-yellow-600">
                                            Sửa
                                        </a>

                                        <a href="${pageContext.request.contextPath}/admin/movies/delete/${m.movieId}"
                                           onclick="return confirm('Bạn chắc chắn muốn xóa phim này?')"
