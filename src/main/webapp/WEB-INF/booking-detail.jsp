...
<div class="page">
  <div class="card">
    ...
    <div class="actions">
      ...
      <form method="post" action="${pageContext.request.contextPath}/admin/bookings/${booking.bookingId}/confirm">
        <button class="btn btn-primary" type="submit">Xác nhận đơn</button>
      </form>

      <form method="post" action="${pageContext.request.contextPath}/admin/bookings/${booking.bookingId}/cancel">
        <button class="btn btn-danger" type="submit">Hủy đơn</button>
      </form>

      <form method="post" action="${pageContext.request.contextPath}/admin/bookings/${booking.bookingId}/send-mail">
